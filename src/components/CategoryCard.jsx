...
<div onClick={()=>navigate(setFiltro(categoryName))} className="w-full max-w-[300px] bg-white border border-gray-200 rounded-2xl shadow dark:bg-gray-800 dark:border-gray-700 relative">
        <Image isZoomed className="aspect-square cursor-pointer" src={urlImage} alt={categoryName} />
