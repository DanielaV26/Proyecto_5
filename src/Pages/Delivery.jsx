  ...
  return (
    <section className="flex gap-4 flex-col w-full md:w-auto">
      ...
      <div className="flex justify-between p-5 mt-3 gap-5">
        ...
        <button className="cursor-pointer font-semibold rounded-xl text-white bg-gradient-to-r from-violet-500 to-fuchsia-500 grow max-w-[300px]  p-2 hover:scale-110" type="submit">Continuar con el pago</button>
      </div>
    </section>
  )
}
