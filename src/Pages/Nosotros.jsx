...
<div className="p-2 pl-16 pr-16">
  <h5 className="text-5xl lg:text-7xl font-cookie mx-auto bg-gradient-to-t from-violet-600 to-yellow-200 text-transparent bg-clip-text mt-8 text-center flex justify-start pl-12 lg:pl-16">Acerca de nosotros</h5>
  ...
  <img className=" h-48 w-full lg:h-96 lg:w-full rounded-xl lg:pl-16 lg:pr-16 lg:mt-12" src="https://res.cloudinary.com/dhijxrbsk/image/upload/v1696737013/MicrosoftTeams-image_3_jwjdyz.jpg" alt="fachada" />
</div>
